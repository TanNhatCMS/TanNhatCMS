...
class Queries(object):
    ...
    async def query_rest(self, path: str, params: Optional[Dict] = None) -> Dict:
        ...
        for _ in range(60):
            ...
            try:
                ...
                if r_async.status == 202:
                    ...
                    print(f"Một đường dẫn {path} trả về 202. Đang thử lại...")
                ...
                print("aiohttp không thành công cho truy vấn còn lại")
                # Fall back on non-async requests
                async with self.semaphore:
        ...
        print("Có quá nhiều 202. Dữ liệu cho {path} sẽ không đầy đủ")
        return dict()
